...
권장 사용 순서: `index 확인 → career-ingest → career-build-general → career-apply-pipeline → rendered output → quality check`.
...
- [sample-experience](wiki/experiences/sample-company.md) - 샘플 경력 정규화 페이지
- [sample-project](wiki/projects/sample-dashboard.md) - 샘플 프로젝트 정규화 페이지
- [sample-award](wiki/awards/sample-award.md) - 샘플 수상 정규화 페이지
- [frontend-engineering](wiki/skills/frontend-engineering.md) - 샘플 기술 역량 정리
...
- [resume-general-v1](outputs/general/resume-general-v1.md) - 범용 이력서 안정형 샘플
