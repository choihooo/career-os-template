...
### 데이터 기반 서비스 아이디어톤 최우수상

2024.07

- 캠퍼스 시설 예약 데이터를 활용한 혼잡도 예측 화면을 설계했다.
- 프론트엔드 담당으로 예약 캘린더, 상태 배지, 관리자 승인 화면을 구현했다.

### 공개 SW 프론트엔드 미니 해커톤 우수상

2023.11

- 공공 API를 활용한 지역 행사 검색 서비스를 제작했다.
- 검색 필터, 카드 리스트, 상세 모달, 모바일 반응형 화면 구현을 담당했다.
...
### GDG Campus Korea 25 | 운영 스태프

2025.03 - 2025.12

- 프론트엔드 세션 운영과 참가자 과제 리뷰를 지원했다.
- Next.js, React, TypeScript 실습 자료의 예제 화면을 점검했다.

### 모두의 타입스크립트 리더

2025.02 - 2025.04

- Next.js 15, React, TypeScript 기반 스터디를 운영했다.
- 주차별 과제 리뷰와 타입 에러 디버깅 세션을 진행했다.

### B2B SaaS 화면 분석 스터디

2024.08 - 2024.11

- 국내외 SaaS 어드민 화면 12개를 분석해 테이블, 필터, 폼 패턴을 정리했다.
- 분석 내용을 바탕으로 URL 상태, 빈 상태, 에러 상태 체크리스트를 작성했다.
